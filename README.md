...
**3. Действие:** Система формирует список "гостей в зоне риска", чтобы маркетинг или отдел продаж могли вовремя предложить им персональную скидку, бонусные баллы или улучшенные сервиса, тем самым сохранив клиента.
...
```bash
| Модель                     | Accuracy   | Recall     | ROC-AUC    | Время (мс) |
|----------------------------|------------|------------|------------|------------|
| Logistic Regression        | 0.8237     | 0.9150     | 0.8601     | 0.0021     |
| **Random Forest**          | **0.8411** | 0.9244     | **0.8805** | 0.0584     |
| Gradient Boosting          | 0.8353     | 0.9204     | 0.8760     | 0.0064     |
| **GridSearchCV (выбрана)** | 0.8120     | **0.9514** | 0.8537     | 0.0021     |
```
...
- **Скорость 0.0024 мс** — в >10,000 раз быстрее требования (100 мс)
