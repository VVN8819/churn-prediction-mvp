...
```bash
Модель                    Recall      Roc Auc       F1        Speed      Precision    Interpret.  Итого
                          (40%)       (25%)       (15%)       (10%)        (5%)          (5%)        
Logistic Regression       0.9150      0.8601      0.8480      1.0000      0.7902         1.0     0.8977
Random Forest             0.9244      0.8805      0.8622      0.9994      0.8078         0.6     0.8895
Gradient Boosting         0.9204      0.8760      0.8573      0.9999      0.8024         0.4     0.8759
GridSearchCV              0.9514      0.8537      0.8448      1.0000      0.7597         1.0     0.9087
```
...
- **Итоговый балл** - 0.9087 по Матрице принятия решения
