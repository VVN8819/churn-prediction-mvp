# d_ml_model/dc_logistic_regression.py
"""
d_ml_model/dc_logistic_regression.py
Обучение, оценка и сохранение модели Logistic Regression для предсказания оттока.
С интеграцией MLflow для трекинга экспериментов.
"""
...
def train_and_evaluate():
    ...
    print("\nВажность признаков (коэффициенты Logistic Regression)")
    ...
    fi_path = PLOTS_DIR / "03_feature_importance_logreg.png"
    ...
    # Сохраняем scaler (понадобится для инференса на новых данных)
    scaler_path = MODELS_DIR / "scaler.joblib"
    joblib.dump(data['scaler'], scaler_path, compress=3)
    ...
    metrics_path = MODELS_DIR / "logistic_regression_metrics.txt"
    with open(metrics_path, 'w', encoding='utf-8') as f:
        f.write("Logistic Regression Model Metrics\n")
    ...
    with tracker.start_run(run_name="logistic_regression"):
