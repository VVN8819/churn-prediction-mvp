...
# Настройки для A/B тестирования (Гипотеза 3)
# Включить автоматическое разделение CRITICAL группы на Control и Treatment
ENABLE_AB_TEST_SPLIT = True

# Коэффициент разделения (0.5 = 50% получают промокод, 50% нет)
AB_TEST_TREATMENT_RATIO = 0.5

# Фиксированный список для воспроизводимости (чтобы при повторном запуске
# в тот же день гости оставались в тойже группе)
AB_TEST_SEED = 42
